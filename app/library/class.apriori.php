...
class Apriori {
    ...
    public function printDataFreqItemsets()
    {
        $result = 'Time: '.$this->fiTime.' second(s)<br />===============================================================================<br />';
        ...
        foreach($this->freqItmsts as $k => $v)
        {
            ...
            $result.= '{'.$tmp.'} = '.$this->allsups[$tmp1].'<br />';
        }
    ...
    public function printDataAssociationRules()
    {
        $return = 'Time: '.$this->arTime.' second(s)<br />===============================================================================<br />';
